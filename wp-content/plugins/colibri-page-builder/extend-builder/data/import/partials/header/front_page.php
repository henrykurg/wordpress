                    ...
                    <ul class="ul-list-icon horizontal-on-desktop horizontal-on-tablet horizontal-on-mobile justify-content-lg-start justify-content-md-start justify-content-start">
                      ...
                      <li class="list-item no-gutters">
                        ...
                        <a href="http://maps.google.com" h-use-smooth-scroll="true" class="item-link no-gutters">
                          <div class="d-flex h-col no-gutters align-items-lg-center align-items-md-center align-items-center list-item-text-wrapper">
                            <div class="d-flex"><span class="h-svg-icon style-141-icon style-local-7-h22-icon"><!--Icon by Font Awesome (https://fontawesome.com)-->[colibri_svg_icon name=font-awesome/map-marker]</span></div> <span class="list-text d-block"><span>Location, State, Country</span></span>
                          </div>
                        </a>
                      ...
                      <li class="list-item no-gutters">
                        ...
                        <a href="http://twitter.com" h-use-smooth-scroll="true" class="item-link no-gutters">
                          <div class="d-flex h-col no-gutters align-items-lg-center align-items-md-center align-items-center list-item-text-wrapper">
                            <div class="d-flex"><span class="h-svg-icon style-141-icon style-local-7-h22-icon"><!--Icon by Font Awesome (https://fontawesome.com)-->[colibri_svg_icon name=font-awesome/phone-square]</span></div> <span class="list-text d-block"><span>(000) 123 12345</span></span>
                          </div>
                        </a>
                        <div class="list-container-divider d-flex justify-content-lg-start justify-content-md-start justify-content-start">
                          <!---->
                      ...
                      <li class="list-item no-gutters">
                        ...
                        <a href="http://maps.google.com" h-use-smooth-scroll="true" class="item-link no-gutters">
                          <div class="d-flex h-col no-gutters align-items-lg-center align-items-md-center align-items-center list-item-text-wrapper">
                            <div class="d-flex"><span class="h-svg-icon style-141-icon style-local-7-h22-icon"><!--Icon by Font Awesome (https://fontawesome.com)-->[colibri_svg_icon name=font-awesome/envelope]</span></div> <span class="list-text d-block"><span>email@yoursite.com</span></span>
                          </div>
                        </a>
                    ...
                    <div data-colibri-component="dropdown-menu" role="navigation" h-use-smooth-scroll-all="true" data-colibri-id="7-h9" class="h-menu h-global-transition-all h-ignore-global-body-typography has-offcanvas-mobile h-menu-horizontal h-dropdown-menu style-9 style-local-7-h9 position-relative h-element">
                      ...
                      <div data-colibri-id="7-h10" class="h-mobile-menu h-global-transition-disable style-10 style-local-7-h10 position-relative h-element">
                        ...
                        <a data-click-outside="true" data-target="#offcanvas-wrapper-7-h10" data-target-id="offcanvas-wrapper-7-h10" data-offcanvas-overlay-id="offcanvas-overlay-7-h10" href="#" data-colibri-component="offcanvas" data-direction="right"
                          data-push="false" title="Menu" class="h-hamburger-button" rel="noopener noreferrer">
            ...
            <div data-colibri-id="7-h27" class="d-flex h-flex-basis h-column__inner h-px-lg-3 h-px-md-3 h-px-3 v-inner-lg-3 v-inner-md-3 v-inner-3 style-21 style-local-7-h27 position-relative">
              ...
              <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
                ...
                <div data-colibri-id="7-h30" class="h-x-container style-24 style-local-7-h30 position-relative h-element">
                  <!---->
                  <div class="h-x-container-inner style-dynamic-7-h30-group style-24-spacing style-local-7-h30-spacing"><span class="h-button__outer style-25-outer style-local-7-h31-outer d-inline-flex h-element"><a h-use-smooth-scroll="true" href=""  data-colibri-id="7-h31" class="d-flex w-100 align-items-center h-button justify-content-lg-center justify-content-md-center justify-content-center style-25 style-local-7-h31 position-relative"><!----><!----> <span>Action button 1</span></a>
                    </span><span class="h-button__outer style-26-outer style-local-7-h32-outer d-inline-flex h-element"><a h-use-smooth-scroll="true" href=""  data-colibri-id="7-h32" class="d-flex w-100 align-items-center h-button justify-content-lg-center justify-content-md-center justify-content-center style-26 style-local-7-h32 position-relative"><!----><!----> <span>Action button 2</span></a>
                    </span>
                  </div>
                </div>
              </div>
        ...
        array (
          ...
          array (
            ...
            array (
              'source' => 
              array (
                'url' => '[colibri_builder_plugin_url]/assets/partials-images/images-xheader-default-0-1545411152082.jpg',
              ),
            ),
          ),
        ),
...
',
  ...
  background-image: url("[colibri_builder_plugin_url]/assets/partials-images/images-xheader-default-0-1545411152082.jpg");
